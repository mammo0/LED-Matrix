...
<form id="animation_settings_form_{{animation_settings.animation_name}}" method="post" autocomplete="off">
                    ...
                    <li class="list-group-item bi-caret-right-fill m-0 p-0 border-0 pl-5">
                        <div class="form-group">
                            ...
                            % else:
                                ...
                                <input id="{{animation_settings.animation_name}}_parameter_{{p_name}}" type="{{input.type}}" class="form-control" name="{{animation_settings.animation_name}}_parameter_{{p_name}}_value" value="{{input.value}}">
                            % end
                        </div>
                    </li>
            %   end
    ...
    % if animation_obj.is_repeat_supported:
        <div class="form-group">
            ...
            <input id="{{animation_settings.animation_name}}_repeat" type="number" class="form-control" name="{{animation_settings.animation_name}}_repeat_value" min="-1" value="{{animation_settings.repeat}}">
        </div>
    % end
</form>
